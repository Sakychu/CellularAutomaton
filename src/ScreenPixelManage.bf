...
namespace CelluarAutomaton
{
	class ScreenPixelManage
	{
		...
		public this(SDL2.SDL.Renderer* r, v2d<double> screenBottomLeftCorner, v2d<double> screenTopRightCorner)
		{
		...
		/// <returns></returns>
		public v2d<double> GetDeltaMathsCoord(v2d<double> pixelCoord)
		{
			v2d<double> result = v2d<double>(
